...
const quickActions = [
  ...
  { label: "สมัครเป็น NEX Digital Agent", href: "/register", isRegisterModal: true },
        ...
        <div className="flex flex-1 items-center justify-center">
          <section className="w-full max-w-md pt-8 text-center sm:pt-10">
            <div className="mx-auto w-full max-w-sm">
              <div className="relative mx-auto h-[176px] w-full overflow-visible sm:h-[224px]">
                <Image
                  src="/nex_logo_nobg.png"
                  alt="NEX Solution"
                  fill
                  className="pointer-events-none object-contain scale-[2.8] drop-shadow-[0_28px_90px_rgba(59,130,246,0.18)]"
                  priority
                  unoptimized
                />
              </div>
