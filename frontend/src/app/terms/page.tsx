        ...
        <div className="p-8 md:p-12">
          ...
          <div className="space-y-8 text-neutral-300 leading-relaxed">
            <section>
              ...
              <p>
                ยินดีต้อนรับสู่ <strong>nexsolution.cloud</strong> ("เรา", "พวกเรา", หรือ "ของเรา") การเข้าถึงและการใช้บริการนี้อยู่ภายใต้ข้อกำหนดและเงื่อนไขดังต่อไปนี้ โปรดอ่านข้อกำหนดเหล่านี้อย่างละเอียดก่อนใช้บริการ หากคุณไม่ยอมรับข้อกำหนดเหล่านี้ โปรดอย่าใช้บริการของเรา
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                บริการและเนื้อหาต้นฉบับ (ไม่รวมเนื้อหาที่ผู้ใช้ให้มา) คุณลักษณะ และฟังก์ชันการทำงาน เป็นทรัพย์สินของ nexsolution.cloud และได้รับการคุ้มครองโดยกฎหมายลิขสิทธิ์
              </p>
            </section>
