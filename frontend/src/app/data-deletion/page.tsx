        ...
        <div className="p-8 md:p-12">
          ...
          <div className="space-y-8 text-neutral-300 leading-relaxed">
            <section>
              ...
              <p>
                หากคุณต้องการลบข้อมูลบัญชีและข้อมูลส่วนบุคคลทั้งหมดของคุณออกจากแอพพลิเคชัน <strong>Digital Business Card (namecard.dpattown.com)</strong> โปรดปฏิบัติตามขั้นตอนดังต่อไปนี้:
              </p>
            </section>
