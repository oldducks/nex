...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#EEF0FF] via-[#F8FAFC] to-[#F8FAFC] text-slate-900 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden">
        <div className="p-8 md:p-12">
          <h1 className="text-3xl md:text-4xl font-bold text-[#050579] mb-8 border-b border-slate-200 pb-4">
          ...
          <div className="space-y-8 text-slate-700 leading-relaxed">
            <section>
              ...
              <p>
                ยินดีต้อนรับสู่ <strong className="text-[#050579]">nexsolution.cloud</strong> (&quot;เรา&quot;, &quot;พวกเรา&quot;, หรือ &quot;ของเรา&quot;) เราให้ความสำคัญกับความเป็นส่วนตัวของคุณและมุ่งมั่นที่จะปกป้องข้อมูลส่วนบุคคลของคุณอย่างเต็มที่ นโยบายความเป็นส่วนตัวนี้จะอธิบายถึงวิธีการที่เราเก็บรวบรวม ใช้ เปิดเผย และรักษาความปลอดภัยของข้อมูลของคุณเมื่อคุณใช้บริการแพลตฟอร์ม Digital Business Card และ Catalog ของเรา
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">1. ข้อมูลที่เราเก็บรวบรวม</h2>
              <p className="mb-4">เราอาจเก็บรวบรวมข้อมูลประเภทต่างๆ ดังนี้:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong className="text-slate-900">ข้อมูลส่วนบุคคล (Personal Data):</strong> เช่น ชื่อ, นามสกุล, อีเมล, เบอร์โทรศัพท์, ข้อมูลการติดต่อทางธุรกิจ, และข้อมูลอื่น ๆ ที่คุณระบุในโปรไฟล์นามบัตรดิจิทัลของคุณ
                </li>
                <li>
                  <strong className="text-slate-900">ข้อมูลการใช้งาน (Usage Data):</strong> เช่น ข้อมูลเกี่ยวกับอุปกรณ์ที่คุณใช้เข้าถึงเว็บไซต์, IP address, ประเภทของเบราว์เซอร์, หน้าที่คุณเยี่ยมชม, เวลาที่ใช้ในหน้าต่างๆ และข้อมูลการโต้ตอบอื่นๆ
                </li>
                <li>
                  <strong className="text-slate-900">ข้อมูลเนื้อหา (Content Data):</strong> ข้อมูลที่คุณอัปโหลดลงในระบบ เช่น รูปภาพโปรไฟล์, รูปภาพสินค้า, วิดีโอ, และข้อมูลใน Catalog ของคุณ
                </li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">2. วิธีการใช้ข้อมูลของคุณ</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">3. การเปิดเผยข้อมูล (Data Disclosure)</h2>
              <p className="mb-4">
                เราจะไม่ขายข้อมูลส่วนบุคคลของคุณให้กับบุคคลที่สาม อย่างไรก็ตาม เราอาจแบ่งปันข้อมูลของคุณในกรณีต่อไปนี้:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong className="text-slate-900">ผู้ให้บริการ:</strong> เราอาจแบ่งปันข้อมูลกับผู้ให้บริการภายนอกที่ช่วยเราในการดำเนินการเว็บไซต์ (เช่น ผู้ให้บริการโฮสติ้ง, บริการวิเคราะห์ข้อมูล) โดยบุคคลเหล่านี้มีหน้าที่รักษาความลับของข้อมูล
                </li>
                <li>
                  <strong className="text-slate-900">ข้อกำหนดทางกฎหมาย:</strong> หากมีความจำเป็นต้องปฏิบัติตามกฎหมาย หรือการร้องขอจากหน่วยงานรัฐที่มีอำนาจ
                </li>
                <li>
                  <strong className="text-slate-900">ข้อมูลสาธารณะ:</strong> ข้อมูลที่คุณเลือกที่จะเปิดเผยในนามบัตรดิจิทัลหรือ Catalog ของคุณ จะถือเป็นข้อมูลสาธารณะที่ผู้อื่นสามารถเข้าถึงได้ผ่านลิงก์ของคุณ
                </li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">4. ความปลอดภัยของข้อมูล (Data Security)</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">5. คุกกี้ (Cookies)</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">6. สิทธิของคุณ (Your Rights)</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">7. การเปลี่ยนแปลงนโยบายความเป็นส่วนตัว</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">8. ติดต่อเรา</h2>
              <p>
