      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden">
        <div className="p-8 md:p-12">
          ...
          <div className="space-y-8 text-slate-700 leading-relaxed">
            <section>
              <p className="mb-4 text-slate-500">ปรับปรุงล่าสุด: 31 มีนาคม 2026</p>
              <p>
                หน้านี้อธิบายวิธีที่ผู้ใช้งานสามารถร้องขอลบบัญชีและข้อมูลที่เกี่ยวข้องกับบริการ
                <strong className="text-[#050579]"> nexsolution.cloud </strong>
                สำหรับการใช้งานบนเว็บและ Android app
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">1. วิธีขอลบบัญชี</h2>
              ...
              <p className="mt-4">
                อีเมลสำหรับคำขอ:
                <span className="ml-2 text-[#F97316] font-semibold">support@dpattown.com</span>
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">2. ข้อมูลที่จะถูกลบ</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">3. ข้อมูลที่อาจยังคงถูกเก็บไว้ชั่วคราว</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">4. ระยะเวลาดำเนินการ</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#050579] mb-4">5. ติดต่อทีมงาน</h2>
              <p>
                หากคุณต้องการลบบัญชีหรือมีคำถามเพิ่มเติมเกี่ยวกับการจัดการข้อมูล โปรดติดต่อ:
              </p>
              <p className="mt-2 text-slate-900 font-semibold">Email: support@dpattown.com</p>
              <p className="mt-4">
                อ่านข้อมูลเพิ่มเติมเกี่ยวกับการจัดการข้อมูลได้ที่{' '}
                <Link href="/privacy" className="text-[#050579] hover:text-[#07079A] underline underline-offset-4">
                  Privacy Policy
                </Link>
              </p>
            </section>
