...
import { Facebook, Instagram, Twitter, Linkedin, Youtube, Globe, Mail, Phone, Github } from 'lucide-react';

// Custom LINE icon
export function LineIcon({ size = 24, className = '' }: { size?: number; className?: string }) {
    return (
        <svg
...
// Social icons mapping with custom icons
export const SOCIAL_ICONS: Record<string, React.ComponentType<{ size?: number; className?: string }>> = {
    facebook: Facebook,
    instagram: Instagram,
    twitter: Twitter,
    x: XIcon,
